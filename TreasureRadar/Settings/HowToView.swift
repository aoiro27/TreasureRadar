        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    step(number: "4", title: "レーダーで探す", body: "探す側で『さがす』を押します。近いほど赤い点は中央に寄り、音の間隔も短くなります。遠いときはBluetoothなので点の位置ではなく距離の変化を頼りにしてください。UWBになると画面の上が『スマホのうしろ側』（カメラがあるほう）です。赤い矢印の向きに歩けば宝に近づきます。方角が出ないときは、スマホをたててうしろ側を部屋のほうへ向けてください。")
